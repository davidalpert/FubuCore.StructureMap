...
1. Delete your local clone of the FubuCore.StructureMap repository
1. Type: `git config --global core.autocrlf false`
1. Type: `git config --system core.autocrlf false`
1. Clone the FubuCore.StructureMap repository again
...
1. open src\FubuCore.StructureMap.sln with Visual Studio and Build the solution
